  ...
  return (
    <div className="mx-5 my-10 px-5 py-10 bg-white shadow-md rounded-xl text-left">
        ...
        <div className="flex justify-between mt-10">
          <button 
          type="button"
          className="py-2 px-10 bg-indigo-700 hover:bg-indigo-700 text-white uppercase font-bold rounded-lg"
          ...
          <button 
          type="button"
          className="py-2 px-10 bg-red-700 hover:bg-red-700 text-white uppercase font-bold rounded-lg"
